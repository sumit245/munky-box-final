...
export default function AuthScene({ name }) {
    ...
    <Provider>
      <ImageBackground source={require("../../assets/imagebackground.jpg")} style={{ width: "100%", height: "100%" }}>
        <SafeAreaView style={styles.container}>
          ...
          <Logo />
          <MobileLogin displayHeader={displayHeader} routeName={name} otpSent={otpSent} />
          <View>
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <Text style={styles.termsCondition}>
            ...
            <Text style={{ textDecorationLine: "underline", color: "#226ccf" }} onPress={() => setTerms(true)} >
